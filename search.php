<?php
    ...
    // Modify the SQL query with search condition
    $sql = "SELECT * FROM barang WHERE nama LIKE '%$searchQuery%' ORDER BY id DESC";
    $query = mysqli_query($conn, $sql);

?>
<!-- Rest of the HTML code to display the search results -->
<!DOCTYPE html>
<html lang="zxx">
<head>
	<!-- Meta Tag -->
						...
						<div class="search-bar-top">
							<div class="search-bar">
								...
								<form method="GET" action="search.php">
									...
									<button class="btnn"><i class="ti-search" name="cari"></i></button>
								</form>
							</div>
						</div>
					</div>
						...
						<div class="shop-sidebar">
							...
							<div class="single-widget category">
								...
								<ul class="categor-list">
									...
									<li><a href="#">Buku & Alat Tulis</a></li>
									<li><a href="#">Gadget & Elektronik</a></li>
